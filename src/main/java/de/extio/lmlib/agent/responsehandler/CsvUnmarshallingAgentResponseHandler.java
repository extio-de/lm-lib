...
public class CsvUnmarshallingAgentResponseHandler implements AgentResponseHandler {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CsvUnmarshallingAgentResponseHandler.class);
	...
	public CsvUnmarshallingAgentResponseHandler(final Class<?> targetClass, final String contextKey) {
